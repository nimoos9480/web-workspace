...
public class MemberDAO {
	 ...
	 * - insert(String mapper, Object param) : int 반환 - DB에 데이터를 입력하고자 할 때 사용
	...
	public int registerMember(SqlSession sqlSession, MemberVO vo) {
		return sqlSession.insert("memberMapper.registerMember", vo); // mapper의 namespace에 접근해서 id값 가져와서 parameter 값 넘기는 것
	}
